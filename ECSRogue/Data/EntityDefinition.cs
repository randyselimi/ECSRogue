...
namespace ECSRogue.Data
{
    ...
    {
        private Dictionary<string, EntityDefinition> entityDefinitions;

        public EntityDefinitionManager(EntityDefinitionLoader entityDefinitionLoader)
        {
            entityDefinitions = entityDefinitionLoader.LoadEntityDefinitions("test");
        }
